...
public class DocServiceTest extends BaseTest {
    ...
    public void insertDoc() throws IOException {
        ...
        User user = new User().setId(1).setName("张三").setAge(18).setSex('男');
    ...
    public void bulkInsertDoc() throws IOException {
        ...
        User user1 = new User().setId(1).setName("张三").setAge(18).setSex('男');
        User user2 = new User().setId(2).setName("李四").setAge(17).setSex('女');
        User user3 = new User().setId(3).setName("王五").setAge(16).setSex('女');
